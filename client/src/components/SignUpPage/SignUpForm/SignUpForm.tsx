...
const SignUpForm = () => {
    ...
    return (
        ...
        >
            <Input _primary _stretch _size={"big"} name={"email"} placeholder={"Email"} autoComplete={"off"}
                   autoCorrect={"off"} value={signUpInput.email} onChange={handleChange} type={"email"} required
            />
            <Input _primary _stretch _size={"big"} type={"password"} name={"password"} placeholder={"Пароль"}
                   minLength={8} maxLength={32} required
                   autoComplete={"new-password"} autoCorrect={"off"} value={signUpInput.password}
                   onChange={handleChange}
            />
            <Input _primary _stretch _size={"big"} name={"name"} placeholder={"Имя пользователя"}
