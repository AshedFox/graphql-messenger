...
You may try client app, deployed on Heroku, [here](https://graphql-messenger-client.herokuapp.com/), 
or discover api with graphql playground [here](https://graphql-messenger-server.herokuapp.com/graphql).
